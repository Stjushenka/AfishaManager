...
class AfishaManagerTest {
    ...
    void shouldAddMoreThanTen() {
        AfishaItem first = new AfishaItem(1, "Фильм1", "http://1.ru", "comedy");
        AfishaItem second = new AfishaItem(2, "Фильм2", "http://2.ru", "action");
        AfishaItem third = new AfishaItem(6, "Фильм5", "http://5.ru", "cartoon");
        AfishaItem fourth = new AfishaItem(3, "Фильм3", "http://3.ru", "horrors");
        AfishaItem fifth = new AfishaItem(4, "Фильм4", "http://4.ru", "cartoon");
        AfishaItem sixth = new AfishaItem(7, "Фильм7", "http://7.ru", "comedy");
        AfishaItem seventh = new AfishaItem(5, "Фильм6", "http://6.ru", "comedy");
        AfishaItem eighth = new AfishaItem(8, "Фильм8", "http://8.ru", "action");
